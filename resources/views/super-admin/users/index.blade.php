                        ...
                        >
                            <span class="flex min-w-0 items-center gap-3">
                                ...
                                <span class="min-w-0 flex-1">
                                    ...
                                    @if ($user->staff_short_code)
                                        <span class="mt-1 block text-xs font-semibold text-[var(--color-muted)]">{{ $user->staff_short_code }}</span>
                                    @endif
                                </span>
                            ...
                            <div class="flex flex-col gap-4 border-b border-[var(--color-border)] pb-5 sm:flex-row sm:items-start sm:justify-between">
                                <div class="flex min-w-0 items-center gap-4">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="mt-1 text-sm font-semibold text-[var(--color-muted)]">Code: {{ $user->staff_short_code ?: 'Not set' }}</p>
                                    </div>
                                </div>
