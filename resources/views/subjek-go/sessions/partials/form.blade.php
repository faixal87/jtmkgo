...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <div>
        ...
        <x-text-input id="academic_session" name="academic_session" class="mt-1 block w-full" :value="old('academic_session', $session?->academic_session)" required />
    ...
    <div class="md:col-span-2">
        ...
        <textarea id="description" name="description" rows="4" class="mt-1 block w-full rounded-lg border-[var(--color-border)] bg-[var(--color-surface)] text-sm text-[var(--color-text)] shadow-sm focus:border-[var(--color-accent)] focus:ring-[var(--color-accent)]">{{ old('description', $session?->description) }}</textarea>
