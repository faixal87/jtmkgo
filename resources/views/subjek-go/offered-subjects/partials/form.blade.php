...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <div>
        ...
        <x-text-input id="course_code" name="course_code" class="mt-1 block w-full uppercase" :value="old('course_code', $subject?->course_code)" placeholder="e.g. DFK40363" required />
    ...
    <div>
        ...
        <x-text-input id="credit_hour" name="credit_hour" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('credit_hour', $subject?->credit_hour)" placeholder="e.g. 3" />
        <x-input-error :messages="$errors->get('credit_hour')" class="mt-2" />
    </div>

    <div>
        <x-input-label for="weekly_contact_hour" value="Weekly Contact Hour" />
        <x-text-input id="weekly_contact_hour" name="weekly_contact_hour" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('weekly_contact_hour', $subject?->weekly_contact_hour)" placeholder="e.g. 5" />
    ...
    <div>
        ...
        <x-text-input id="total_class_groups" name="total_class_groups" type="number" min="1" class="mt-1 block w-full" :value="old('total_class_groups', $subject?->total_class_groups ?? 1)" placeholder="e.g. 5" required />
